...
describe('Dolibarr Modulo Comercial', function() {
    it('Dolibarr - Crear Presupuesto', function() {
        browser.url('http://52.54.130.109/dolibarr/comm/propal/card.php?action=create&leftmenu=propals')
...
describe('Dolibarr Modulo Comercial', function() {
    it('Dolibarr - Crear Pedido', function() {
		...
		browser.url('http://52.54.130.109/dolibarr/commande/card.php?action=create&leftmenu=orders')
